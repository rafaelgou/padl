...
$architect = new Padl\LicenseArchitect($file, false, true, true, true);
...
$key =  (
        $gen_key == 'KEY_EXISTS' || 
        $gen_key == 'WRITE_TARGET_404' || 
        $gen_key == 'WRITE_TARGET_UNWRITEABLE' || 
        $gen_key == 'WRITE_FAILED' || 
        $gen_key == 'DOMAIN_IP_FAIL' || 
        $gen_key == 'SERVER_FAIL'
        ) ? false : $gen_key;
